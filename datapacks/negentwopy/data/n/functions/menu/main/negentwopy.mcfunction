...
scoreboard players operation @s level = @s levelN2
scoreboard players operation @s tmp = @s levelN2
...
execute store result score @s levelMax run data get storage n:levels n2
