...
scoreboard players operation @s level = @s levelCo
scoreboard players operation @s tmp = @s levelCo
...
execute store result score @s levelMax run data get storage n:levels co
