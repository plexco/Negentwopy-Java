...
execute store result score #circ tmp run data get block 0 4 0 RecordItem.tag.pieces.circ
...
execute if score #circ tmp matches 1.. run replaceitem entity @s hotbar.6 oak_fence{CustomModelData:9,type:"circ",CanPlaceOn:["minecraft:yellow_concrete","minecraft:black_concrete"],HideFlags:16,display:{Name:'{"translate":"n.piece.circ","color":"red","italic":false}'}}
